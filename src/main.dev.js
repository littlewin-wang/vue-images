...
new Vue({
  el: '#app',
  template: '<lightbox :imgs="images" :modalclose="modalclose" :keyinput="keyinput" :mousescroll="mousescroll" :showclosebutton="showclosebutton" :showcaption="showcaption" :imagecountseparator="imagecountseparator" :showimagecount="showimagecount" :showthumbnails="showthumbnails" :deletebtn="deletebtn" @delete="deleteAjax"/>',
  data () {
    return {
      images: [
        {
  ...
  methods: {
    deleteAjax (imageId) {
      console.log('[DEBUG_MAIN]do some ajax to delete image with id ' + imageId)
    }
  },
  components: {
    lightbox
